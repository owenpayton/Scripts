...
Config.instname = "University of California-Santa Barbara"
Config.profilename = "eduroam"
Config.url = "https://ucsb.service-now.com/it"
Config.email = "noc@ucsb.edu"
Config.title = "eduroam CAT"
Config.server_match = "eduroam.wireless.ucsb.edu"
...
Config.user_realm = "ucsb.edu"
Config.ssids = ['eduroam']
Config.del_ssids = ['UCSB Secure', 'UCSB Setup', 'UCSB Wireless Web']
Config.servers = ['DNS:eduroam.wireless.ucsb.edu']
Config.use_other_tls_id = False
Config.anonymous_identity = "anonymous@ucsb.edu"
